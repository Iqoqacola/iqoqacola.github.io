        ...
        <div className="w-[300px] h-[475px] p-4 border-2 border-black rounded-lg shadow-lg bg-secondary flex flex-col justify-center items-center hover:bg-thirdty transition duration-300 ease-in-out">
          ...
          <div className="mt-4 flex flex-wrap gap-2 justify-center">
            <a
              href={linkCode}
              target="_blank"
              className="bg-black text-white px-3 py-2 rounded-md flex gap-2 border-2 hover:border-black hover:bg-white hover:text-black transition ease-in-out duration-300"
            >
              <svg
                role="img"
                viewBox="0 0 24 24"
